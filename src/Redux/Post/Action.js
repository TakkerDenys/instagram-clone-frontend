...
export const createPost = (data) => async (dispatch) => {
  ...
  try {
      const res = await fetch("http://192.168.88.176:8080/api/posts/create", {
    method: "POST",
...
export const findUserPost = (data) => async (dispatch) => {
  ...
  const res = await fetch(
    `http://192.168.88.176:8080/api/posts/following/${data.userIds}`,
    {
      method: "GET",
...
export const reqUserPostAction = (data) => async (dispatch) => {
  ...
  const res = await fetch(
    `http://192.168.88.176:8080/api/posts/following/${data.userId}`,
    {
      method: "GET",
...
export const likePostAction = (data) => async (dispatch) => {
  ...
  const res = await fetch(
    `http://192.168.88.176:8080/api/posts/like/${data.postId}`,
    {
      method: "PUT",
...
export const unLikePostAction = (data) => async (dispatch) => {
  ...
  const res = await fetch(
    `http://192.168.88.176:8080/api/posts/unlike/${data.postId}`,
    {
      method: "PUT",
...
export const savePostAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(`http://192.168.88.176:8080/api/posts/save_post/${data.postId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + data.jwt,
...
export const unSavePostAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(`http://192.168.88.176:8080/api/posts/unsave_post/${data.postId}`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + data.jwt,
...
export const findPostByIdAction=(data)=>async(dispatch)=>{
  try {
    const res=await fetch(`http://192.168.88.176:8080/api/posts/${data.postId}`,{
    method:"GET",
    headers:{
      "Content-Type":"application/json",
      Authorization:"Bearer "+data.jwt,
...
export const deletePostAction = (data) => async (dispatch) => {
  ...
  try {
    const res = await fetch(`http://192.168.88.176:8080/api/posts/delete/${data.postId}`, {
    method: "DELETE",
    headers: {
      "Content-Type": "application/json",
      Authorization: "Bearer " + data.jwt,
